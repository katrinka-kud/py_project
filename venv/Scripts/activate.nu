...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\root\PycharmProjects\py_project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\root\PycharmProjects\py_project\venv\Scripts\deactivate.nu'
